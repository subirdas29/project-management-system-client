...
export default function KanbanTaskCard({ task }: { task: any }) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`inline-block px-2 py-0.5 rounded text-[10px] my-3 capitalize ${STATUS_COLOR[task.status]}`}
      >
        {task.status}
      </span>
